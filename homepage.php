...
<body>
  <form action="/information.php <?php echo $_SERVER['PHP_SELF'];?>" method="post">
    ...
    <input type="text" id="" name="numberCustomer" value="100">
    <label>Ngày</label>
    <input type="datetime-local" id="" name="date" value="Doe"><br>
    ...
    <input type="text" id="nameCustomer" name="nameCustomer" value="Nguyễn Duy Phương">
    <label>Địa chỉ liên lạc </label>
    <input type="text" id="address" name="address" value="123 Sư vạn hạnh">
    <br>
    ...
    <select id="knowTo" name="knowTo" size="3" multiple>
    ...
    <button type="submit" onclick="alert('Đặt thành công')">Đặt chỗ</button>
    </fieldset>
  </form>
